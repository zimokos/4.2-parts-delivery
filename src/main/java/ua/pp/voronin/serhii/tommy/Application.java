...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        // Коробки
        Collection<Box> emptyBoxesList = List.of(
                new Box(700),
                new Box(500),
                new Box(500),
                new Box(500),
        ...
        new PartsProcessor().packageParts(partsList, emptyBoxesList, boxPackagingPricePerMeter); // Підказка: в цьому виклиці складно розібратися з сігнатурою через погані імена зммінних.
    }
}
